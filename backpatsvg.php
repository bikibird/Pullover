...
print "M ".($centerX-$BkNeckW1/2*$scale)." ".$topY." ";

switch($backNeckline)
{
	case "B":
		print "l ".($BkNeckW1*$scale)." 0 ";
		break;
	case "R":
		print "a ".($BkNeckW1*$scale/2)." ".($BkNeckD*$scale)." 0 0 0 ".(($BkNeckW1)*$scale)." 0 ";
		break;
	case "V":
		print "l ".($BkNeckW1/2*$scale)." ".($BkNeckD*$scale)." ";
		print "l ".($BkNeckW1/2*$scale)." ".(-$BkNeckD*$scale)." ";
		break;
		
	case "S":
		print "l 0 ".($BkNeckD*$scale)." ";
		print "l ".($BkNeckW1*$scale)." 0 ";
		print "l 0 ".(-$BkNeckD*$scale)." ";
		break;
}
...
//shoulder
print "l ".(($ShW-$BkNeckW1)/2*$scale)." ".($ShS*$scale);
